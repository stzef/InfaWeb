...
class ArticleForm(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			...
			#'canti' : forms.TextInput(attrs={'type_input':'text','class': 'form-control input-currency','required':True,'step':'0.01','min':0}),
			...
			'pvta1': forms.TextInput(attrs={'class': 'form-control input-currency','required':True,'step':'0.01','min':0}),
			'pvta2': forms.TextInput(attrs={'class': 'form-control input-currency','step':'0.01','min':0}),
			'pvta3': forms.TextInput(attrs={'class': 'form-control input-currency','step':'0.01','min':0}),
			'pvta4': forms.TextInput(attrs={'class': 'form-control input-currency','step':'0.01','min':0}),
			'pvta5': forms.TextInput(attrs={'class': 'form-control input-currency','step':'0.01','min':0}),
			'pvta6': forms.TextInput(attrs={'class': 'form-control input-currency','step':'0.01','min':0}),
