...
urlArticles = [
	...
	url(r'^article/edit/(?P<pk>[0-9]{2})/$', ArticleUpdate.as_view(), {'title': 'Editar Articulos'}, name = 'edit-article'),
]
urlGroups = [
	...
	url(r'^group/edit/(?P<pk>[0-9]{2})/$', GroupUpdate.as_view(), {'title': 'Editar Grupo'}, name = 'edit-group'),
]
