...
urlUnits = [
	url(r'^units/$', login_required(UnitsList.as_view()), name = 'list-units'),
	url(r'^units/add/$', login_required(UnitCreate.as_view()), name = 'add-unit'),
	url(r'^units/edit/(?P<pk>\d+)/$', login_required(UnitUpdate.as_view()), name = 'edit-unit'),
]
