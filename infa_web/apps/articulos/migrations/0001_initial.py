# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-08-23 11:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carlosglo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carlosglo', to='articulos.Arlos')),
                ('carlosp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carlosp', to='articulos.Arlos')),
                ('cesdo', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='base.Esdo')),
            ],
        ),
        migrations.CreateModel(
