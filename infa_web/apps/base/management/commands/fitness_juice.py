	...
	def handle(self, *args, **options):
		...
		if(confirmation == "Si"):
			...
			Arlo.objects.using(name_db).create(
				...
				cbarras='',
				ncorto='Tropical - Sin Helado',
				nlargo='Tropical - Sin Helado',
				canti=0,
				stomin=0,
				stomax=0,
				pvta1=2200,
			...
			Arlo.objects.using(name_db).create(
				...
				cbarras='',
				ncorto='Tropical - Con Helado',
				nlargo='Tropical - Con Helado',
				canti=0,
				stomin=0,
				stomax=0,
				pvta1=2500,
			...
			Arlo.objects.using(name_db).create(
				...
				cbarras='',
				ncorto="Vientre Plano - Mediano",
				nlargo="Vientre Plano - Mediano",
				canti=0,
				stomin=0,
				stomax=0,
				pvta1=1200,
			...
			Arlo.objects.using(name_db).create(
				...
				cbarras='',
				ncorto="Vientre Plano - Grande",
				nlargo="Vientre Plano - Grande",
				canti=0,
				stomin=0,
				stomax=0,
				pvta1=1500,
