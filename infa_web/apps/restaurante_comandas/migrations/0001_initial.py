    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detaanula', models.CharField(blank=True, default='', max_length=250, null=True)),
        ...
        migrations.CreateModel(
            name='Mesas',
            fields=[
                ('cmesa', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Meseros',
            fields=[
                ('cmero', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cesdo', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='base.Esdo')),
                ('csucur', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='base.Sucursales')),
            ],
        ),
        migrations.AddField(
            model_name='meseros',
